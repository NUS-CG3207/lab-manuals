...
Please follow the instructions in the [RISC-V Programming](../rv_programming.md) page configure RARS and to write programs. The .hex file generated by the program is inserted into the ROMs within Wrapper.v to "program" the RISC-V processor using the procedure mentioned in that page.
