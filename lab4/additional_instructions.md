...
Add support for the following previously unsupported instructions / features. The first 4 categories are pretty easy to add at this point and will allow you to run almost all the code generated by a compiler such as https://godbolt.org/.
